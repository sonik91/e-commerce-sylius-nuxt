<template>
  <div class="">
    <div class="relative">
      <SfLink :href="product.url" class="block">
        <img
    ...
    <div class="p-4 border-t border-neutral-200">
      <SfLink :href="product.url" variant="secondary" class="no-underline">{{ product.name }}</SfLink>
      <div class="flex items-center pt-1">
        <div v-if="product.averageRating">
          <SfRating size="xs" :value="product.averageRating" :max="5" />
        </div>
      </div>
      <p class="my-2 font-normal leading-5 typography-text-sm text-neutral-700 line-clamp-3">
      ...
      <p :class="[currentVariant?.inStock ? 'text-green-500' : 'text-red-500']">
